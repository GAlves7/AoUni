                ...
                <View style={styles.topoCaixa}>
                    <View style={styles.logoNomeWrapper}>
                        <Image 
                            ...
                            resizeMode="contain"
                        />
                        <Text style={styles.nomeGrupo}>UNINASSAU Caruaru - Direito</Text>
                    </View>
                </View>
                <View style={styles.meioCaixa}>
                    <Text style={styles.descricaoGrupo}>
                        Este é um grupo focado em discutir e compartilhar conteúdos relacionados ao curso de Direito na UNINASSAU.
                    </Text>
                </View>
